    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_security', models.CharField(blank=True, choices=[('G', 'Grants'), ('CF', 'CF'), ('CFRC', 'CF Running costs')], max_length=4, null=True, verbose_name='Soc. Sec')),
                ('socialsecurity_is_paid', models.NullBooleanField(default=None, verbose_name='Paying Social Security')),
                ...
                ('warning_contract_ending', models.BooleanField(default=True, help_text='Send an alert warning the end of the contract', verbose_name='Warn when the contract is ending')),
            ],
            options={
